...
from life.models.deit.ms_qkv import MultiscaleQKV
...
default_cfgs = {
    ...
    'swinv2_tiny_window8_64_patch1': _cfg(
        url='',
        input_size=(3, 64, 64)
    ),
    'swinv2_tiny_window8_32_patch1': _cfg(
        url='',
        input_size=(3, 32, 32)
    ),
...
class WindowAttention(nn.Module):
    ...
    def __init__(
        ...
        if self.use_ms:
            self.qkv = MultiscaleQKV(dim, dim//3, cls_token=False)
        else:
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
            ...
            act_layer=nn.GELU, norm_layer=nn.LayerNorm, pretrained_window_size=0, use_ms=False):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(
            ...
            mlp_ratio=4., qkv_bias=True, drop=0., attn_drop=0., drop_path=0.,
            norm_layer=nn.LayerNorm, downsample=None, pretrained_window_size=0, use_ms=False):
...
def swinv2_tiny_window16_256(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_tiny_window16_256'],
...
@register_model
def swinv2_tiny_window16_256_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_tiny_window16_256'],
        window_size=16, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window16_256_ms', pretrained=pretrained, **model_kwargs)
...
def swinv2_tiny_window8_256(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        default_cfg = default_cfgs['swinv2_tiny_window8_256'],
...
@register_model
def swinv2_tiny_window8_256_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_tiny_window8_256'],
        window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window8_256_ms', pretrained=pretrained, **model_kwargs)


@register_model
def swinv2_tiny_window8_64_patch1(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg = default_cfgs['swinv2_tiny_window8_64_patch1'],
        patch_size=1, window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window8_64_patch1', pretrained=pretrained, **model_kwargs)


@register_model
def swinv2_tiny_window8_64_patch1_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_tiny_window8_64_patch1'],
        patch_size=1, window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window8_64_patch1_ms', pretrained=pretrained, **model_kwargs)


@register_model
def swinv2_tiny_window8_32_patch1(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg = default_cfgs['swinv2_tiny_window8_32_patch1'],
        patch_size=1, window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window8_32_patch1', pretrained=pretrained, **model_kwargs)


@register_model
def swinv2_tiny_window8_32_patch1_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_tiny_window8_32_patch1'],
        patch_size=1, window_size=8, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_tiny_window8_32_patch1_ms', pretrained=pretrained, **model_kwargs)
...
def swinv2_small_window16_256(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_small_window16_256'],
...
@register_model
def swinv2_small_window16_256_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_small_window16_256'],
        window_size=16, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_small_window16_256', pretrained=pretrained, **model_kwargs)
...
def swinv2_small_window8_256(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_small_window8_256'],
...
@register_model
def swinv2_small_window8_256_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_small_window8_256'],
        window_size=8, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_small_window8_256', pretrained=pretrained, **model_kwargs)
...
def swinv2_base_window8_256(pretrained=False, **kwargs):
    ...
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_base_window8_256'],
...
@register_model
def swinv2_base_window8_256_ms(pretrained=False, **kwargs):
    """
    """
    model_kwargs = dict(
        default_cfg=default_cfgs['swinv2_base_window8_256'],
        window_size=8, embed_dim=128, depths=(2, 2, 18, 2), num_heads=(4, 8, 16, 32),
        use_ms=True, **kwargs)
    return _create_swin_transformer_v2('swinv2_base_window8_256', pretrained=pretrained, **model_kwargs)
